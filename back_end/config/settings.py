...
CELERY_BEAT_SCHEDULE = {
    'notify-stale-pending-policies': {
        'task': 'apps.notifications.tasks.remind_stale_pending_policies',
...
DEFAULT_FROM_EMAIL  = config('DEFAULT_FROM_EMAIL',  default='noreply@insurance-erp.com')
